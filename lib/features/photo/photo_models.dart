...
extension PhotoMoodLabel on PhotoMood {
  String get label {
    switch (this) {
      ...
      case PhotoMood.COZY:
        return '아늑한';
      case PhotoMood.EMOTIONAL:
        return '감성적인';
      case PhotoMood.LONELY:
        return '외로운';
      case PhotoMood.ROMANTIC:
        return '로맨틱';
      case PhotoMood.DREAMY:
        return '몽환적인';
      case PhotoMood.VINTAGE:
        return '빈티지';
      case PhotoMood.FRESH:
        return '청량한';
      case PhotoMood.HEALING:
        return '힐링';
      case PhotoMood.SENTIMENTAL:
        return '감성';
      case PhotoMood.MODERN:
        return '모던';
      case PhotoMood.CINEMATIC:
        return '시네마틱';
      case PhotoMood.QUIET:
        return '고요한';
      case PhotoMood.BRIGHT:
        return '밝은';
      case PhotoMood.NIGHT:
        return '야경';
      case PhotoMood.NOSTALGIC:
        return '추억의';
    }
  }
}
...
extension PhotoTimeTagLabel on PhotoTimeTag {
  String get label {
    switch (this) {
      case PhotoTimeTag.MORNING:
        return '아침';
      case PhotoTimeTag.AFTERNOON:
        return '오후';
      case PhotoTimeTag.SUNSET:
        return '노을';
      case PhotoTimeTag.NIGHT:
        return '야간';
    }
  }
}
...
extension CrowdLevelLabel on CrowdLevel {
  String get label {
    switch (this) {
      case CrowdLevel.RELAXED:
        return '한산';
      case CrowdLevel.NORMAL:
        return '보통';
      case CrowdLevel.CROWDED:
        return '복잡';
      case CrowdLevel.HARD_TO_SHOOT:
        return '촬영어려움';
    }
  }
}
...
class PhotoInfo {
  ...
  factory PhotoInfo.fromJson(Map<String, dynamic> json) => PhotoInfo(
    ...
    ddaomCount: (json['ddaomCount'] as num?)?.toInt() ?? 0,
...
class PhotoLikeResult {
  ...
  factory PhotoLikeResult.fromJson(Map<String, dynamic> json) =>
      PhotoLikeResult(
        photoId: (json['photoId'] as num).toInt(),
...
class PhotoUploadRequest {
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (sourcePhotoId != null) 'sourcePhotoId': sourcePhotoId,
